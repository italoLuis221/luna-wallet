...
insert into setor_atuacao(id, setor, sub_setor, segmento) values(1, 'Energia', 'Geração de Enenrgia', 'Geração');
insert into setor_atuacao(id, setor, sub_setor, segmento) values(2, 'Financeiro', 'Seguros', 'Seguros e Financiamento');
insert into classe_ativo(id, descricao) values(1, 'Ações');
insert into classe_ativo(id, descricao) values(2, 'FII');
